...
\usepackage[
	pdftitle={Phrasierung},
    pdfsubject={Hausarbeit - B.A. Linguistik - Universität Bielefeld},
    pdfauthor={Fabian Wohlgemuth},
    pdfkeywords={B.A., Hausarbeit, Bachelor, Linguistik, Musik, Singen, Chor, Universität Bielefeld},
    %pdftex=true,
    colorlinks=true,
    citecolor=black,
    linkcolor=black,
